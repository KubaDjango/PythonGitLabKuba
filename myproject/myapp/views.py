...
#           Run create gitlab hierarchy function
            try:
                ...
                gitlab_url = "https://gitlab.com/groups/bartosz.slepowron-group/-/epics?state=opened&page=1&sort=start_date_desc&label_name%5B%5D=Initiative%20Level%3A%3ATop%20Level"
                return HttpResponse(
